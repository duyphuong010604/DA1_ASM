                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <?php $nameBrand=$brand->getById($fk_brandId); ?>
                                        <td>Thương hiệu</td>
                                        <td>Mã : <?=$fk_brandId?> - <?=$nameBrand['name']?></td>
                                    </tr>
                                    <tr>
                                        <?php $nameCategory=$category->getById($fk_categoryId);?>
                                        <td>Loại sản phẩm</td>
                                        <td>Mã: <?=$fk_categoryId?> - <?=$nameCategory['name']?></td>
                                    </tr>
                                    <tr>
                                        <td>Giá</td>
