                ...
                <div class="col-lg-6">
                    <div class="login_box_img">
                        ...
                        <div class="hover">
                            ...
                            <a class="primary-btn" href="<?= $ROOT_URL?>/routerClient.php?act=register">Tạo tài khoản</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login_form_inner">
                        <h3>Đăng Nhập</h3>
                        <form class="row login_form" action="<?= $ROOT_URL?>/routerClient.php?act=login" method="post" id="contactForm"
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <a href="<?= $ROOT_URL?>/routerClient.php?act=quenmatkhau">Quên mật khẩu?</a>
                            </div>
                        </form>
                    </div>
                </div>
