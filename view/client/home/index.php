                            ...
                            <div class="product-details">
                                ...
                                <div class="prd-bottom">
                                    ...
                                    <a href="" class="social-info">
                                        ...
                                        <p class="hover-text">+ Giỏ hàng</p>
                                    </a>
                                    <a href="" class="social-info">
                                        <span class="fa-solid fa-barcode fa-2xs"></span>
                                        <p class="hover-text">Mua ngay</p>
                                    </a>
                                    <a href="<?= $ROOT_URL ?>/routerClient.php?act=chitiet-sp" class="social-info">
    ...
    <div class="single-product-slider">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-title">
                        <h1>Các sản phẩm giá tốt nhất</h1>
                        <p>Toàn bộ sản phẩm đều đảm bảo hàng chính hảng.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <img class="img-fluid" src="<?= $CONTENT_URL ?>/client/img/product/p6.jpg" alt="">
                        <div class="product-details">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <img class="img-fluid" src="<?= $CONTENT_URL ?>/client/img/product/p8.jpg" alt="">
                        <div class="product-details">
                            <h6>addidas New Hammer sole
                                for Sports person</h6>
                            <div class="price">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <img class="img-fluid" src="<?= $CONTENT_URL ?>/client/img/product/p3.jpg" alt="">
                        <div class="product-details">
                            <h6>addidas New Hammer sole
                                for Sports person</h6>
                            <div class="price">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <img class="img-fluid" src="<?= $CONTENT_URL ?>/client/img/product/p5.jpg" alt="">
                        <div class="product-details">
                            <h6>addidas New Hammer sole
                                for Sports person</h6>
                            <div class="price">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <img class="img-fluid" src="<?= $CONTENT_URL ?>/client/img/product/p1.jpg" alt="">
                        <div class="product-details">
                            <h6>addidas New Hammer sole
                                for Sports person</h6>
                            <div class="price">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-product">
                        <img class="img-fluid" src="<?= $CONTENT_URL ?>/client/img/product/p4.jpg" alt="">
                        <div class="product-details">
                            <h6>addidas New Hammer sole
                                for Sports person</h6>
                            <div class="price">
