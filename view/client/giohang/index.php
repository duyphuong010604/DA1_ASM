                                ...
                                <td>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            ...
                                            <img src="<?= $UPLOAD_IMG_URL ?>/products/<?= $cart[3] ?>" alt="" width='80px'
                                                height='80px'>
                                        </div>
                            ...
                            <td>
                                <form action="<?= $ROOT_URL ?>/routerClient.php?act=giohang" method="post">
                                    <input type="text" class="form-control" name='makhuyenmai'
                                        placeholder="Nhập mã khuyến mãi nếu có &amp; nhấn enter">
                                </form>
                            ...
                            <td>
                                <div class="checkout_btn_inner d-flex align-items-center ">
                                    <a class="gray_btn " href="<?= $ROOT_URL ?>/routerClient.php?act=sanpham">Tiếp
                                        tục mua sắm</a>
                                    <a class="primary-btn"
                                        href="<?= $ROOT_URL ?>/routerClient.php?act=<? if ($tongtienthanhtoan >= 1000) {
                                              echo "thanhtoan";
                                          } else {
                                              echo "#";
                                          } ?>" <?php
