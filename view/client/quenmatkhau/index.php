                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            <li class="nav-item active"><a class="nav-link" href="index.html">Trang chủ</a></li>
                            <li class="nav-item submenu dropdown">
                                <a href="hello" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="false">Sản phẩm</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="category.html">Tất cả sản
                                            phẩm</a></li>
                            ...
                            <li class="nav-item"><a href="#" class="nav-link"><i class="fa-solid fa-bag-shopping"></i>
                                    Giỏ hàng</a></li>
                        </ul>
                        <!-- <ul class="nav navbar-nav navbar-right ">
                        ...
                        <ul class='nav navbar-nav menu_nav ml-auto'>
                            <li class="nav-item submenu dropdown">
                                ...
                                <a href="#" class="genric-btn danger-border circle">Đăng nhập</a>
                            </li>
                        </ul>
                    </div>
                </div>
			...
			<div class="row">				
				<div class="col-md-8 mx-auto col-12">
					<div class="login_form_inner">
						...
						<form class="row login_form mb-5" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="name" placeholder="Tên tài khoản" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
							</div>
                            <div class="col-md-12 form-group">
                ...
                <div class="col-lg-3  col-md-6 col-sm-6">
                    <div class="single-footer-widget mail-chimp">
                        ...
                        <ul class="instafeed d-flex flex-wrap">
                            <li><img src="../../../contents/client/img/i1.jpg" alt=""></li>
                            <li><img src="../../../contents/client/img/i2.jpg" alt=""></li>
                            <li><img src="../../../contents/client/img/i3.jpg" alt=""></li>
                            <li><img src="../../../contents/client/img/i4.jpg" alt=""></li>
                            <li><img src="../../../contents/client/img/i5.jpg" alt=""></li>
                            <li><img src="../../../contents/client/img/i6.jpg" alt=""></li>
                            <li><img src="../../../contents/client/img/i7.jpg" alt=""></li>
                            <li><img src="../../../contents/client/img/i8.jpg" alt=""></li>
                        </ul>
                    </div>
                </div>
